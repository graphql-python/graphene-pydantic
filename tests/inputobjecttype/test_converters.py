...
import graphene_pydantic.inputobjecttype.converters as converters
from graphene_pydantic.inputobjecttype.converters import (
    ConversionError,
    convert_pydantic_field,
)
from graphene_pydantic.inputobjecttype.registry import get_global_registry
...
def test_required_string():
    ...
    assert isinstance(field, graphene.InputField)
